...
// Import your Prices array if it's defined in the specified location.
...
const HomePage = () => {
  ...
  const getAllCategory = async () => {
    try {
      ...
      console.log(error, "all categories not showing");
        ...
        <div className="col-md-2">
          ...
          <div className="d-flex flex-column mt-2 mb-2">
            <Radio.Group onChange={(e) => setRadio(e.target.value)}>
              {/* Replace Prices?.map with your actual price range mapping */}
              {Prices?.map((p) => (
                <div key={p._id}>
